...
/**
 * Brand icons (GitHub / LinkedIn) — lucide-react removed all brand icons
 * in recent versions, so we keep our own minimal inline SVGs.
 * Same API as lucide icons: size via className, color via currentColor.
 */
